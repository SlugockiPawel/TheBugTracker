...
namespace TheBugTrucker.Controllers
{
    public class InvitesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CompanyId,ProjectId,InvitorId,InviteeId,InviteeEmail,InviteeFirstName,InviteeLastName,InviteDate,JoinDate,CompanyToken,IsValid")] Invite invite)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyId,ProjectId,InvitorId,InviteeId,InviteeEmail,InviteeFirstName,InviteeLastName,InviteDate,JoinDate,CompanyToken,IsValid")] Invite invite)
        {
            if (id != invite.Id)
            {
                return NotFound();
